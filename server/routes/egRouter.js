...
router.get('/', (req, res) => {
    res.status(200).json({ 
        ...
        getPageTitle:'http://localhost:4005/getPageTitle',
        getAllCookies:'http://localhost:4005/getAllCookies',
        getElementContentOrAttr:'http://localhost:4005/getElementContentOrAttr'
...
router.get('/getPageTitle', async (req, res) => {
    ...
    res.status(200).json({ home:'http://localhost:4005',content: content })
}
);
